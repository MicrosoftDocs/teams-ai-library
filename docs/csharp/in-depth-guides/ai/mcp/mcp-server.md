---
title: MCP Server (C#)
description: Tutorial on implementing an MCP (Machine Conversation Protocol) server in Teams C# applications using the McpPlugin, covering server configuration, tool exposure, and message handling for features like human-in-the-loop interactions and notifications.
ms.topic: how-to
ms.date: 09/26/2025
---
...
:::image type="content" source="..\..\..\..\assets\screenshots\mcp-devtools.gif" alt-text="Animated image of user opening 'MCP Inspector' from DevTools and selecting 'Connect' to inspect the available tools on the MCP server running on localhost." lightbox="..\..\..\..\assets\screenshots\mcp-devtools.gif":::
