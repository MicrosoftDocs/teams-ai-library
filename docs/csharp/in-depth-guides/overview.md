...
description: Detailed technical guides covering advanced features and capabilities of Teams SDK in C#, including AI integration, adaptive cards, dialogs, authentication, and message extensions.
ms.topic: overview
ms.date: 09/26/2025
---
