---
title: How Auth Works (preview) (C#)
description: Implement user authentication and SSO in Teams applications using the
 Teams AI Library for C#.
ms.topic: how-to
ms.date: 07/16/2025
---
# How Auth Works (preview) (C#)
