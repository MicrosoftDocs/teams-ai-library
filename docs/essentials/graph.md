...
> [!NOTE]
>
> If you're migrating from an earlier preview version of the Teams SDK, see the [migrations overview](../migrations/overview.md) for the current migration paths.
::: zone-end
