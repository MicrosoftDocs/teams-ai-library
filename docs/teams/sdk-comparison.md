...
:::image type="content" source="~/assets/diagrams/sdk-comparison-architecture.png" alt-text="Architecture diagram comparing M365 Agents SDK and Microsoft Teams SDK with different channels and services" lightbox="~/assets/diagrams/sdk-comparison-architecture.png" :::
...
- **Sticking with Teams SDK?** Continue to [Get started](../get-started/quickstart-register.md) or the [TypeScript](../getting-started/overview.md?tabs=typescript) / [C#](../getting-started/overview.md?tabs=csharp) / [Python](../getting-started/overview.md?tabs=python) guides.
