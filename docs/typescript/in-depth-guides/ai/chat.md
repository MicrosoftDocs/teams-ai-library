...
:::image type="content" source="~/assets/diagrams/chat-1.png" alt-text="Diagram showing user prompt being sent to a Model, which then routes it various LLMProviders (Azure OpenAI, OpenAI, Claude, ...)." lightbox="~/assets/diagrams/chat-1.png":::
