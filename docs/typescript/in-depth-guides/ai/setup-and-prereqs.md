...
description: Prerequisites and setup guide for integrating LLMs into Teams SDK TypeScript applications, including API keys and Azure OpenAI configuration.
ms.topic: how-to
ms.date: 09/18/2025
---
