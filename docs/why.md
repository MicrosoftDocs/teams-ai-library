...
:::image type="content" source="~/assets/diagrams/why.png" alt-text="Flowchart showing Teams input and output events flowing to and from your application" lightbox="~/assets/diagrams/why.png":::
...
:::image type="content" source="~/assets/diagrams/why-2.png" alt-text="Flowchart showing the Teams ecosystem with authentication, public-facing endpoints, and event routing" lightbox="~/assets/diagrams/why-2.png":::
...
:::image type="content" source="~/assets/diagrams/why-3.png" alt-text="Block diagram showing input events like user messaged, user reacted, and form submitted routed to corresponding application handlers" lightbox="~/assets/diagrams/why-3.png":::
...
:::image type="content" source="~/assets/diagrams/why-4.png" alt-text="Block diagram showing application authentication with external services including OAuth/SSO, Graph, GitHub, and Google" lightbox="~/assets/diagrams/why-4.png":::
