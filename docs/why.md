...
:::image type="content" source="~/assets/diagrams/diagram-why-1.png" alt-text="Flowchart showing the public endpoint, app ID, and authentication components required before using an SDK." lightbox="~/assets/diagrams/diagram-why-1.png" :::
...
:::image type="content" source="~/assets/diagrams/diagram-why-2.png" alt-text="Flowchart showing how authenticated Teams events arrive through one public endpoint and require different handling paths." lightbox="~/assets/diagrams/diagram-why-2.png" :::
...
:::image type="content" source="~/assets/diagrams/diagram-why-3.png" alt-text="Diagram showing the branching event-handling complexity an app must manage without SDK abstractions." lightbox="~/assets/diagrams/diagram-why-3.png" :::
