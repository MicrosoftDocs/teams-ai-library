...
:::image type="content" source="~/assets/diagrams/diagram-why-1.png" alt-text="Flowchart showing the minimum components required for a Teams agent application" lightbox="~/assets/diagrams/diagram-why-1.png" :::
...
:::image type="content" source="~/assets/diagrams/diagram-why-2.png" alt-text="Flowchart showing how public URL, app identity, and authentication fit together" lightbox="~/assets/diagrams/diagram-why-2.png" :::
...
:::image type="content" source="~/assets/diagrams/diagram-why-3.png" alt-text="Block diagram showing many Teams event types entering one public endpoint" lightbox="~/assets/diagrams/diagram-why-3.png" :::
...
:::image type="content" source="~/assets/diagrams/diagram-why-4.png" alt-text="Block diagram showing outbound authentication to Teams and Microsoft Graph" lightbox="~/assets/diagrams/diagram-why-4.png" :::
