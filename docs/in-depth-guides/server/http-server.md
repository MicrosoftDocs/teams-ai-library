...
:::image type="content" source="~/assets/diagrams/http-server.png" alt-text="Flowchart showing HTTP server adapter flow for Teams requests through authentication and parsing to handlers" lightbox="~/assets/diagrams/http-server.png":::
