...
You will need to deploy a model in Azure OpenAI. View the [resource creation guide](/azure/ai-services/openai/how-to/create-resource#deploy-a-model 'Azure OpenAI Model Deployment Guide') for more information on how to do this.
::: zone-end
