...
# [Teams SDK v2 (Option 1)](#tab/adaptive-cards-v2-option1)
...
# [Teams SDK v2 (Option 2)](#tab/adaptive-cards-v2-option2)
...
# [Teams SDK v1](#tab/adaptive-cards-v1)
```python
    @app.message("/card")
    async def adaptive_card(context: TurnContext, _state: AppTurnState) -> bool:
        attachment = CardFactory.adaptive_card(
