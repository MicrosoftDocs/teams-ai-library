...
**Option 1**: For existing cards like this, the simplest way to convert that to Teams SDK is this:
...
**Option 2**: For a more thorough port, you could also do the following:
